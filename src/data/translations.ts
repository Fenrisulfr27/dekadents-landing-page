export const translations = {
  en: {
    ...
    statisticsEyebrow: "Community activity",
    statisticsDescription:
      "A public aggregate view of Dekadents Discord activity.",
    statisticsLoadError:
      "Could not load statistics right now. Please try again later.",
    activeUsers: "Active users",
    withMessages: "Users with recorded messages",
    totalLines: "Total lines",
    totalWords: "Total words",
    totalPoints: "Total points",
    pointUsers: "users with points",
  ...
  et: {
    ...
    statisticsEyebrow: "Kogukonna aktiivsus",
    statisticsDescription:
      "Avalik koondvaade Dekadentsi Discordi aktiivsusele.",
    statisticsLoadError:
      "Statistikat ei õnnestunud praegu laadida. Proovi hiljem uuesti.",
    activeUsers: "Aktiivsed kasutajad",
    withMessages: "Salvestatud sõnumitega kasutajad",
    totalLines: "Ridu kokku",
    totalWords: "Sõnu kokku",
    totalPoints: "Punkte kokku",
    pointUsers: "punktidega kasutajat",
    periodActivity: "Perioodide aktiivsus",
    today: "Täna",
    thisWeek: "See nädal",
    thisMonth: "See kuu",
    thisYear: "See aasta",
